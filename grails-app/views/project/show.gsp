		...
		<div id="show-project" class="content scaffold-show" role="main">
			...
			<ol class="property-list project">
                ...
                <div class="form-group">
                    <label for="name" class="control-label"><g:message code="ott.name.label" default="Name" /></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" placeholder="${projectInstance?.name}" disabled>
                    </div>
                </div>
                <div class="form-group">
                    <label for="description" class="control-label"><g:message code="ott.description.label" default="Description" /></label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="description" name="description" placeholder="${projectInstance?.description}" disabled>
                    </div>
                </div>

                <g:message code="ott.users.label" default="Users" />
                ...
                <g:message code="ott.tasks.label" default="Tasks" />
			...
			<g:form>
				...
				<fieldset class="buttons">
                    ...
                    <g:link class="btn btn-warning" action="edit" params="[id:projectInstance?.id]"><g:message code="ott.button.edit.label"/></g:link>
